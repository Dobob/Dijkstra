...
class BinomialQueue
{
  ...
  public:
    ...
    void merge( BinomialQueue & rhs );
		...
		//DECREASE ONLY! new_key must be less than obj's value, otherwise you get undesired result.
		void decreaseKey(Comparable & obj, const DistType & new_key);
